...
$arr_am_titles = array("Facebook", "Friendfeed", "Feedburner", "Flickr", "Delicious", "GitHub", "Google Plus", "Instagram", "MySpace", "LinkedIn", "Pinterest", "Posterous", "Skype", "StumbleUpon", "Technorati", "Twitter", "YouTube", "Tumblr", "Xing");
...
function control_aboutme()
{
    ...
    <div class="wrap">
        ...
        <div id="message" class="updated fade">
            ...
            <p>
                Help us to improve our plugin. Your feedback will be appreciated. Feel free to post your <a href="http://www.wpspeedster.com/blog/about-me-3000-widget/#comment" target="_blank"><strong>comment</strong></a>
        ...
        <form name="aboutme3000_form" method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>" enctype="multipart/form-data">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="text" id="aboutme-title" name="aboutme-title" value="<?php echo $options['title']; ?>" />
            ...
            <label for="aboutme-grav_on">Show gravatar</label><br />*/ ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="aboutme-grav_on" value="0" <?php echo ((@$options["grav_on"] == '0' || @$options["grav_on"] == '') ? ' checked=true' : ''); ?>>
                        Show nothing<br />
                        <input type="radio" name="aboutme-grav_on" value="1" <?php echo ((@$options["grav_on"] == '1') ? ' checked=true' : ''); ?>> Show
                        Gravatar<br />
                        <input type="radio" name="aboutme-grav_on" value="2" <?php echo ((@$options["grav_on"] == '2') ? ' checked=true' : ''); ?>> Show
                        uploaded image
                    </td>
                </tr>
                <tr>
                ...
                ?>
                    <tr>
                        ...
                        <td><input type="text" id="aboutme-<?php echo $tag_id ?>" name="aboutme-<?php echo $tag_id ?>" value="<?php echo @$options[$tag_id]; ?>" /> <img src="<?php echo get_bloginfo('wpurl') ?>/wp-content/plugins/about-me-3000/<?php echo $tag_id ?>.png" border="0"><br />
                            <?php /*
                            if ($i == 0) { ?>
